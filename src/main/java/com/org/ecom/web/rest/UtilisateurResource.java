...
import com.org.ecom.repository.UtilisateurRepository;
...
/**
 * REST controller for managing {@link com.org.ecom.domain.Utilisateur}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Utilisateur> partialUpdateUtilisateur(
        ...
        Optional<Utilisateur> result = utilisateurRepository
            ...
            .map(existingUtilisateur -> {
                ...
                if (utilisateur.getCourriel() != null) {
                    existingUtilisateur.setCourriel(utilisateur.getCourriel());
                }
