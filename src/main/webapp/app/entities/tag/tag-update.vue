  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2 id="ecomApp.tag.home.createOrEditLabel" data-cy="TagCreateUpdateHeading" v-text="$t('ecomApp.tag.home.createOrEditLabel')">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('ecomApp.tag.name')" for="tag-name">Name</label>
            <input
              type="text"
              class="form-control"
              name="name"
