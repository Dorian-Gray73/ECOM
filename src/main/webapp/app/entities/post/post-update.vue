  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2 id="ecomApp.post.home.createOrEditLabel" data-cy="PostCreateUpdateHeading" v-text="$t('ecomApp.post.home.createOrEditLabel')">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('ecomApp.post.title')" for="post-title">Title</label>
            <input
              type="text"
              class="form-control"
              name="title"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('ecomApp.post.content')" for="post-content">Content</label>
            <textarea
              class="form-control"
              name="content"
              id="post-content"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('ecomApp.post.date')" for="post-date">Date</label>
            <div class="d-flex">
              <input
                id="post-date"
                data-cy="date"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('ecomApp.post.blog')" for="post-blog">Blog</label>
          ...
          <div class="form-group">
            <label v-text="$t('ecomApp.post.tag')" for="post-tag">Tag</label>
            <select
              class="form-control"
              id="post-tags"
              data-cy="tag"
