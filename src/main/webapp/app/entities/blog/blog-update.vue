  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2 id="ecomApp.blog.home.createOrEditLabel" data-cy="BlogCreateUpdateHeading" v-text="$t('ecomApp.blog.home.createOrEditLabel')">
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('ecomApp.blog.name')" for="blog-name">Name</label>
            <input
              type="text"
              class="form-control"
              name="name"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('ecomApp.blog.handle')" for="blog-handle">Handle</label>
            <input
              type="text"
              class="form-control"
              name="handle"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('ecomApp.blog.user')" for="blog-user">User</label>
